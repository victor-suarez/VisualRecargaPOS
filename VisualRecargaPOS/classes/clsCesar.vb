...
Public Class clsCesar
    ...
    Private Sub CargarKeys()
        ...
        ArrSems(0) = "62072" : ArrSems(1) = "51804"
        ArrSems(2) = "10107" : ArrSems(3) = "03629"
        ArrSems(4) = "63714" : ArrSems(5) = "36291"
        ArrSems(6) = "80264" : ArrSems(7) = "07286"
    ...
    Private Function Encrypt(ByVal valor As String) As String
        ...
        For CicloInter = 1 To cInterac
            ...
            For idxVal = 0 To (sTempVal.Length - 1)
                ...
                iChar = System.Convert.ToByte(sTempVal.Chars(idxVal)) + Microsoft.VisualBasic.Val(cSemilla.Chars(idxSem))
